...
getDataOfType :: Word16 -> ByteOrder -> Int -> Type -> Get Data
...
getDataOfType tag bo n t = do
 ...
 where
  getData :: Data -> Int -> Get Data
  getData ds 0 = return (reverseData ds)
  getData ds n = do
   ds' <- getOne ds 
   getData ds' (n-1)
  getOne :: Data -> Get Data
...
getExifData :: Get [Data]
getExifData = do
 getToApp1
 ifds <- lookAhead $ getExifIFDs
